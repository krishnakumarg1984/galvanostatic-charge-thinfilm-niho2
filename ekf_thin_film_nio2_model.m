...
function [overall_XZ_residual_vector, flag, new_data,rhs_of_state_eqn] = ekf_thin_film_nio2_model(t,XZ,XZp,user_data_struct) % x_tot contains both x (differential states), z (algebraic variables) and derivates of states
